...
import { useGetAllPostsQuery, useGetFollowersQuery, useGetUserByIdQuery } from "state/api-hook";
import UserWidget from "./UserWidget";
import Widget from "pages/friends/Widget";
...
const HomeFeed = () => {
  ...
  const filteredFollowers = followers.filter((follower) => !following.includes(follower));
